...
// beside the app can look at the document the user has open - and, in a later
// stage, edit it - while the user watches the same window.
//
...
const NODE_ID_NOTE = 'Node ids are only valid until the document is next edited - every edit renumbers them - so re-read rather than reusing ids across an edit.';
