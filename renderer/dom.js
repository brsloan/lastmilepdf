...
export const el = {
  ...
  preferencesAgentEnabled: asInput('preferences-agent-enabled'),
  preferencesAgentStatus: asElement('preferences-agent-status'),
  preferencesAgentDetails: asElement('preferences-agent-details'),
  preferencesAgentCommand: asInput('preferences-agent-command'),
