...
export const el = {
  ...
  splitContentPanel: asElement('split-content-panel'),
  splitContentField: asTextarea('split-content-field'),
  splitContentUnavailable: asElement('split-content-unavailable'),
  btnSplitContent: asButton('btn-split-content'),
  ...
  settingsCustomBaseUrl: asInput('settings-custom-base-url'),
  settingsCustomModel: asInput('settings-custom-model'),
  settingsCustomApiKey: asInput('settings-custom-api-key'),
  ...
  preferencesTagShortcutsList: asElement('preferences-tag-shortcuts-list'),
  preferencesProofreadShortcutsList: asElement('preferences-proofread-shortcuts-list'),
  preferencesAutoSave: asInput('preferences-auto-save'),
  preferencesAutoCheckUpdates: asInput('preferences-auto-check-updates'),
  desktopAgentsDialog: asDialog('desktop-agents-dialog'),
  btnCloseDesktopAgents: asButton('btn-close-desktop-agents'),
  agentsEnabled: asInput('agents-enabled'),
  agentsStatus: asElement('agents-status'),
  agentsDetails: asElement('agents-details'),
  agentsCommand: asInput('agents-command'),
  btnCopyAgentCommand: asButton('btn-copy-agent-command'),
  ...
  agentsJson: asTextarea('agents-json'),
  btnCopyAgentJson: asButton('btn-copy-agent-json'),
  agentsFixPrompt: asTextarea('agents-fix-prompt'),
  ...
  shortcutsBody: asElement('shortcuts-body'),
  btnCloseShortcuts: asButton('btn-close-shortcuts'),
  quickstartDialog: asDialog('quickstart-dialog'),
  quickstartBody: asElement('quickstart-body'),
  quickstartNav: asElement('quickstart-nav'),
  btnCloseQuickstart: asButton('btn-close-quickstart'),
  helpDialog: asDialog('help-dialog'),
  helpBody: asElement('help-body'),
  helpNav: asElement('help-nav'),
  btnCloseHelp: asButton('btn-close-help'),
  whatsNewDialog: asDialog('whats-new-dialog'),
  whatsNewTitle: asElement('whats-new-title'),
  whatsNewBody: asElement('whats-new-body'),
  btnCloseWhatsNew: asButton('btn-close-whats-new'),
